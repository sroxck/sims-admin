<template>
  <el-aside class="w-64 bg-gray-50">
    <el-menu router class="bg-gray-50" :default-active="path">
    <div class="logo h-20">33</div>
      <sideItem v-for="(route,index) in routerList" :key="index" :item="route"></sideItem>
    </el-menu>
  </el-aside>
</template>
